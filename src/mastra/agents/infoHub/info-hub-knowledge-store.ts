...
import { createKnowledgeStoreFromHtml } from '../rag/utils/create-knowledge-store';
...
export class InfoHubKnowledgeStore {
  ...
  constructor({
    ...
    this.vector = vector;
    this.indexName = indexName || infoHubStoreIndexName;
    this.log = log;
    this.topK = topK;
  }
